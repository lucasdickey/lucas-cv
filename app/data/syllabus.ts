  ...
  },
  {
    ...
    readings: [
      ...
      },
      {
        ...
        format: "essays",
        status: "pending",
        coverUrl: "/images/syllabus/machines-of-loving-grace.svg",
        note: "The optimistic case, from the frontier lab's own vantage point: what a decade of powerful AI could do for biology, economics, and governance if the risks are managed well.",
      ...
      },
      {
        ...
        format: "essays",
        status: "pending",
        coverUrl: "/images/syllabus/the-adolescence-of-technology.svg",
        note: "The companion risk essay: bioterrorism, autonomous weapons, mass labor displacement, and AI-enabled authoritarianism — and what it would take to defend against them.",
